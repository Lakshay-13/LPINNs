...
def render(solver, name=None):
    ...
    heatmap = np.log(heatmap/np.max(heatmap) + 0.001)
...
class HO():
    def __init__(self, t_0=0.0, u_0=0.0, u_0_prime = 1.0, t_min=0.0, t_max=4*np.pi, 
                 ...
                 input_neurons=[32,32], lr = 1e-2, activation = nn.SiLU, initial_sigma=None, sigma_min=None, sigma_max=None, localization=True):
