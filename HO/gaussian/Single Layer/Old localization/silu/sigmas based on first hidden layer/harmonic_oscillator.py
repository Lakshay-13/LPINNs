...
class HO():
    def __init__(self, t_0=0.0, u_0=0.0, u_0_prime = 1.0, t_min=0.0, t_max=4*np.pi, 
                 ...
                 input_neurons=[32,32], lr = 1e-2, activation = nn.SiLU):
        ...
        mu = mu
        sigma = sigma
        nets = [CustomNN(n_input_units=1, n_output_units=1, hidden_units=input_neurons, actv=activation, t_min=t_min, t_max=t_max, mu_learnable=mu, sigma_learnable=sigma)]
